...
void setup() {
  ...
  circles.add(new Circle(width/4*1, height/4*3, 200, 150, 50, mySerialInterface, 1)); //It is very important that the total number of LEDs correspond to the number of LEDs registered on the Teensy
  circles.add(new Circle(width/4*1, height/4*1, 100, 75, 25, mySerialInterface, 2));
  circles.add(new Circle(width/4*2, height/4*1, 100, 75, 25, mySerialInterface, 3));
  circles.add(new Circle(width/4*3, height/4*3, 100, 75, 25, mySerialInterface, 4));
  circles.add(new Circle(width/4*3, height/4*2, 100, 75, 25, mySerialInterface, 5));
